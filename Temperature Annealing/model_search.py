...
class Network(nn.Module):
    ...
    def forward(self, x):
        ...
        #     t = 0.1 
        #     if cell.reduction: 
        #         weights = F.softmax(self.alpha_reduce/t, dim=-1) 
        #     else:
        #         weights = F.softmax(self.alpha_normal/t, dim=-1) 
    ...
    def genotype(self):
        ...
        # t = 0.1
        # gene_normal = _parse(F.softmax(self.alpha_normal/t, dim=-1).data.cpu().numpy())
        # gene_reduce = _parse(F.softmax(self.alpha_reduce/t, dim=-1).data.cpu().numpy())
