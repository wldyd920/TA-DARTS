...
class Arch:
    ...
    def comp_unrolled_model(self, x, target, eta, optimizer, temperature):
        """
        ...
        unrolled_model = self.construct_model_from_theta(theta, temperature)

        return unrolled_model

    def step(self, x_train, target_train, x_valid, target_valid, eta, optimizer, unrolled, temperature):
        """
        ...
        if unrolled:
            self.backward_step_unrolled(x_train, target_train, x_valid, target_valid, eta, optimizer, temperature)
        else:
    ...
    def backward_step_unrolled(self, x_train, target_train, x_valid, target_valid, eta, optimizer, temperature):
        """
        ...
        unrolled_model = self.comp_unrolled_model(x_train, target_train, eta, optimizer, temperature)
    ...
    def construct_model_from_theta(self, theta, temperature):
        """
        ...
        :return:
        """
        model_new = self.model.new(temperature=temperature)
