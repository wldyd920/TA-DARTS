...
parser.add_argument('--exp_path', type=str, default='exp/cifar100', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='CIFAR100', help='which architecture to use')
...
def main():
    ...
    model = Network(args.init_ch, args.classes, args.layers, args.auxiliary, genotype).cuda()
    ...
    for epoch in range(args.epochs):
        ...
        # two lines of codes here was in the for loop above
